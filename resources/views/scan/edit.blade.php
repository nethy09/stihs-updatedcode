<!-- Edit Modal -->
<div class="modal fade" id="edit{{$item_instance->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('instance.update',$item_instance->id) }}"
                method="POST">
                @csrf
